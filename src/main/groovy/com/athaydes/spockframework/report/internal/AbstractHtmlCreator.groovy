...
abstract class AbstractHtmlCreator<T> {
    ...
    String htmlHeader = ''
    String htmlFooter = "Generated by <a href='${SpockReportExtension.PROJECT_URL}'>Athaydes Spock Reports</a>"
    ...
    String reportFor( T data ) {
        ...
        builder.html {
            head {
                ...
                if ( htmlHeader ) mkp.yieldUnescaped( htmlHeader )
            }
            body {
